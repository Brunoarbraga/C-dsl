...
/* package text-display-0.0.5.1 */
#ifndef VERSION_text_display
#define VERSION_text_display "0.0.5.1"
#endif /* VERSION_text_display */
#ifndef MIN_VERSION_text_display
#define MIN_VERSION_text_display(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 5)
#endif /* MIN_VERSION_text_display */
